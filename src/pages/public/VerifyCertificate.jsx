  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <div className="px-8 py-5 border-b border-surface-dim/20 bg-surface-container-lowest flex items-center justify-between">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 text-outline hover:text-primary text-sm font-bold transition-colors"
        >
        ...
        <div className="w-full max-w-2xl space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-on-surface-variant max-w-md mx-auto">
              Enter the certificate's verification code to confirm its
          ...
          <form
            ...
            className="bg-surface-container-lowest border border-surface-dim/20 rounded-3xl p-8 shadow-xl space-y-5"
          >
            <div>
              ...
              <p className="text-xs text-outline mt-2">
                The verification code is printed at the bottom of the PDF
                certificate.
              </p>
            </div>
            <button
            ...
            >
              {loading ? (
                ...
                <>
                  <Shield className="w-5 h-5" /> Verify Certificate
                </>
              )}
            </button>
          </form>
            ...
            <div className="bg-surface-container-lowest border-2 border-emerald-500/30 rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="px-8 pb-8">
                ...
                >
                  {copied ? (
                    <>
                      <Check className="w-4 h-4 text-emerald-500" /> Link
                      Copied!
                    </>
                  ) : (
                    <>
            ...
            <div className="bg-surface-container-lowest border-2 border-red-500/30 rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="p-8">
                <p className="text-on-surface-variant leading-relaxed">
                  We could not find a certificate matching the code{" "}
                  <strong className="font-mono text-primary">
                    {inputCode}
                  </strong>
                  . Please double-check the code on your PDF certificate and try
                  again.
                </p>
                <ul className="mt-5 space-y-2 text-sm text-outline list-disc list-inside">
                  <li>
                    Codes are case-insensitive but must be entered exactly
                  </li>
      ...
      <div className="text-center py-6 text-xs text-outline border-t border-surface-dim/10">
        Certificate verification powered by LMS Platform · Instant and
        tamper-proof
      </div>
    </div>
  );
  ...
  return (
    <div className="flex items-start gap-4 p-4 bg-surface-container rounded-2xl border border-surface-dim/10">
      ...
      <div className="min-w-0">
        ...
        <p
          className={`font-bold leading-tight break-all ${mono ? "font-mono text-sm" : "text-base"} ${valueClass}`}
        >
          {value}
        </p>
      </div>
