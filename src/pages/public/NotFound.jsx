  ...
  return (
    <main className="min-h-screen bg-surface flex items-center justify-center p-8 relative overflow-hidden">
      <div className="max-w-xl w-full text-center relative z-10">
        ...
        <h1 className="text-8xl font-headline font-extrabold text-primary mb-6 tracking-tighter italic">
          404
        </h1>
        <h2 className="text-3xl font-headline font-bold text-on-surface mb-6 italic uppercase tracking-widest">
          Page Not Found
        </h2>
        <p className="text-lg text-on-surface-variant font-medium leading-relaxed mb-12 opacity-70 italic">
          The requested page could not be found. Please check the URL or return
        ...
        <div className="mt-20 pt-12 border-t border-surface-dim/20">
          <p className="text-[10px] font-bold text-secondary uppercase tracking-[0.4em]">
            STAR LMS • Page Not Found
          </p>
        </div>
      </div>
    </main>
